...
public class TransactionsApiController : ControllerBase
{
    ...
    public TransactionsApiController(ARCon_Capstone_2_DbContext context, INotificationService notificationService)
    {
        _context = context;
    ...
    // this will make transaction status = CONFIRMED
    [HttpPut("{id}/confirm")]
    public async Task<IActionResult> ConfirmOrder(int id)
    {
        ...
        await _notificationService
            .SendToCustomerAsync(
                ...
                $"Your order {transaction.transaction_code} has been confirmed and is now being processed.",
    ...
    public async Task<IActionResult> RejectOrder(int id)
            ...
            .SendToCustomerAsync(
                ...
                $"Your order {transaction.transaction_code} has been marked as rejected. You may contact our Customer Service for further details.",
    ...
    public async Task<IActionResult> CancelOrderByAdmin(int id, [FromBody] CancelOrderDto dto)
    {
        ...
        await _notificationService
            .SendToCustomerAsync(
                ...
                $"Your order {transaction.transaction_code} has been marked as cancelled. You may contact our Customer Service for further details.",
